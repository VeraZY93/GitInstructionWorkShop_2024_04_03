...
в данной инструкции необходимо сделать описание по каждому пункту
...
2. Открыть загрузки и найти скачанный файл.
3. Запустить двойным кликом VSCodeUserSetup-{version}.exe.
4. По умолчанию приложение появится в папке Programs\Microsoft\VS Code.
